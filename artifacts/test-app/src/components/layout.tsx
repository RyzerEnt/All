    ...
    >
      ...
      <header style={{
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto", padding: "0 1.25rem", height: 60, display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          ...
          <div style={{ display: "inline-flex", alignItems: "center", gap: "0.5rem", background: "rgba(249,115,22,0.1)", border: "1px solid rgba(249,115,22,0.25)", borderRadius: 999, padding: "0.25rem 0.75rem" }}>
      ...
      <footer style={{ borderTop: "1px solid rgba(15,23,42,0.08)", background: "#fff", padding: "1.5rem 1.25rem", textAlign: "center" }}>
        <p style={{ fontSize: "0.72rem", color: "rgba(15,23,42,0.35)", fontWeight: 500, letterSpacing: "0.04em" }}>
